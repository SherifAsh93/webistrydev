...
const TEXT = {
  ar: {
    headline: "عايز تطور مشروعك / شغلك وتخليه أسهل؟",
    subtext: "اكتب فكرة بسيطة عن مشروعك كمرجع، واحنا هنكلمك عشان ناخد التفاصيل و أنفذ المناسب لنشاطك",
    nameLabel: "الاسم",
    namePlaceholder: "اكتب اسمك هنا",
    nameError: "من فضلك اكتب اسمك",
    messageLabel: "اكتب لنا فكرة مشروعك / شغلك",
    messagePlaceholder: "مثال: عايز موقع لمحلي، أو تطبيق إدارة لعمارتي",
    recordBtn: "سجل",
    ...
    cancel: "إلغاء",
    recordedLabel: (t: string) => `الرسالة اتسجلت — ${t}`,
    play: "سماع",
    pause: "إيقاف",
    ...
    successBody: "هنكلمك في أقرب وقت على الرقم اللي كتبته. خليك على استعداد 📞",
    successAgain: "تسجيل شخص تاني",
  },
  en: {
    headline: "Want to grow your business and make it easier to run?",
    subtext: "Share a quick idea about your project as a starting point — we'll call you to get the details and build what fits your business.",
    nameLabel: "Name",
    namePlaceholder: "Enter your name",
    nameError: "Please enter your name",
    messageLabel: "Tell us about your project idea",
    messagePlaceholder: "e.g. I need a website for my shop, or a management app for my building",
    recordBtn: "Record",
    ...
    cancel: "Cancel",
    recordedLabel: (t: string) => `Voice message recorded — ${t}`,
    play: "Play",
    pause: "Pause",
    reRecord: "Re-record",
    ...
    successBody: "We'll call you soon on the number you provided. Stay ready 📞",
    successAgain: "Sign up someone else",
  },
} as const;
...
export default function LeadPageClient({ lang }: { lang: Lang }) {
  const t = TEXT[lang];
  ...
  function validateFields(): boolean {
    ...
    const pErr = validatePhone(phone, t);
    if (pErr) {
      setPhoneError(pErr);
      ok = false;
    } else setPhoneError("");
  ...
  if (formStatus === "success") {
    return (
      <div dir={dir} lang={lang} className="min-h-screen bg-gradient-to-b from-teal-50 to-white flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center flex flex-col items-center gap-5">
          ...
          <h1 className="text-2xl font-extrabold text-slate-900">{t.successTitle}</h1>
          <p className="text-slate-500 leading-relaxed">{t.successBody}</p>
          <button
            onClick={resetAll}
  ...
  return (
    <div dir={dir} lang={lang} className="min-h-screen bg-gradient-to-b from-teal-50 to-white flex items-start md:items-center justify-center px-4 py-6 md:py-10">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-7">
          ...
          <p className="text-slate-500 text-base leading-relaxed">{t.subtext}</p>
        </div>
        ...
        <div className="bg-white border border-teal-100 rounded-3xl shadow-xl shadow-teal-900/5 p-6 flex flex-col gap-4">
          ...
          <div>
            <div className="flex items-center justify-between gap-2 mb-2">
              <label className="text-xs font-bold text-slate-500">{t.messageLabel}</label>
              {recordState === "idle" && (
                <button
                  type="button"
            ...
            <div className="rounded-2xl border-2 border-teal-100 bg-teal-50/40 p-4">
              {recordState === "requesting" && (
                <div className="flex items-center gap-3 py-1">
                  ...
                  <p className="text-sm text-slate-500 font-medium">{t.requestingMic}</p>
                </div>
              )}
              ...
              {recordState === "recording" && (
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-slate-400 font-semibold">{t.recordingLabel}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <Square size={13} fill="currentColor" /> {t.stopRecording}
                    </button>
                    <button
                      type="button"
                      onClick={cancelVoice}
              ...
              {recordState === "recorded" && (
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex items-center gap-2 text-teal-700">
                    ...
                    <span className="font-bold text-sm">{t.recordedLabel(formatTime(recordSeconds))}</span>
                  </div>
